...
export default function AlumniHero() {
  ...
  return (
    <section ref={containerRef} className="relative h-[90vh] overflow-hidden bg-gradient-to-b from-white to-zinc-100 dark:from-[#0B1120] dark:to-[#0B1120]">
        ...
        >
          ...
          <motion.div className="space-y-4">
            ...
            >
              ...
              />
              <motion.span 
                className="absolute inset-0 -z-10 bg-gradient-to-r from-indigo-500/10 via-purple-500/10 to-pink-500/10 dark:from-indigo-500/5 dark:via-purple-500/5 dark:to-pink-500/5 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300"
              />
              
              {/* Text Content */}
              <motion.p 
                className="relative z-10 text-xl text-zinc-600/90 dark:text-zinc-400/90 max-w-2xl mx-auto leading-relaxed group-hover:text-zinc-800 dark:group-hover:text-zinc-200 transition-colors duration-300"
              >
                Connect with fellow graduates and unlock new opportunities in our thriving community
              </motion.p>
          ...
          >
            ...
            >
              ...
              >
                ...
                <motion.div 
                  className="absolute inset-0 rounded-lg bg-gradient-to-r from-purple-500/20 via-indigo-500/20 to-pink-500/20 dark:from-purple-500/20 dark:via-blue-500/20 dark:to-pink-500/20 opacity-0 group-hover:opacity-100 transition-all duration-200"
                />
              </Button>
            </motion.div>
          </motion.div>
